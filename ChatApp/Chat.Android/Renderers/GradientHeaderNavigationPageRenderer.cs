...
namespace BasicApp.Droid.Renderers
{
    public class GradientHeaderNavigationPageRenderer : NavigationPageRenderer
    {
        ...
        //{
        //    Tuple<Color, Color> colors = new Tuple<Color, Color>(Color.FromHex("#44579C"), Color.FromHex("#44579C"));
